...
import com.android.mb.assistant.activity.competitive.CompetitiveManagerActivity;
 ...
 */
public class NewHomeFragment extends BaseMvpFragment<CommonPresenter, ICommonView> implements ICommonView, OnRefreshListener, OnLoadMoreListener {
    ...
    private void initView(View view) {
        ...
        mGridCate.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                if (i == 0) {
                    //一线支撑
                    showToastMessage("开发中，敬请期待...");
                }else if (i == 1){
                    //物资管理
                    NavigationHelper.startActivity(getActivity(), GoodsManagerActivity.class,null,false);
                }else if (i == 2){
                    //竞情管理
                    NavigationHelper.startActivity(getActivity(), CompetitiveManagerActivity.class,null,false);
                }else if (i == 3){
                    //其他服务
                    showToastMessage("开发中，敬请期待...");
                }
    ...
    private List<IType> getHomeTypeList(){
        ...
        homeTypeList.add(new IType(R.mipmap.icon_yixian,"一线支撑"));
        homeTypeList.add(new IType(R.mipmap.icon_wzgl,"物资管理"));
        homeTypeList.add(new IType(R.mipmap.icon_jqgl,"竞情管理"));
        homeTypeList.add(new IType(R.mipmap.icon_other,"其他服务"));
        return homeTypeList;
    }
