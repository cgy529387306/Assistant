 ...
 * 选择型号
 */
public class SelectPatternActivity extends BaseMvpActivity<CommonPresenter, ICommonView> implements ICommonView, BaseQuickAdapter.OnItemClickListener, OnRefreshListener, OnLoadMoreListener {
    ...
    protected void bindViews() {
        ...
        mAdapter = new PatternAdapter(new ArrayList());
    ...
    public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
        PatternBean item = mAdapter.getData().get(position);
        Intent intent = new Intent();
        intent.putExtra("pattern",item);
    ...
    public void requestSuccess(String requestCode, String result) {
        PatternListResp listResp = JsonHelper.fromJson(result, PatternListResp.class);
        if (listResp!=null){
            if (listResp.isLast()){
