...
public class CommonPresenter extends BaseMvpPresenter<ICommonView> implements ICommonPresenter {
    ...
    @Override
    public void requestCart(String requestCode, Map<String, String> params, boolean isShowLoading) {
        if (isShowLoading){
            mMvpView.showProgressDialog("请稍后...");
        }
        Observable observable = ScheduleMethods.getInstance().cartRequest(requestCode,params);
        toSubscribe(observable,  new Subscriber<String>() {
            @Override
            public void onCompleted() {
    ...
    @Override
    public void requestAppraise(String requestCode, Map<String, String> params, boolean isShowLoading) {
        if (isShowLoading){
            mMvpView.showProgressDialog("请稍后...");
        }
        Observable observable = ScheduleMethods.getInstance().appraiseRequest(requestCode,params);
        toSubscribe(observable,  new Subscriber<String>() {
            @Override
            public void onCompleted() {
    ...
    @Override
    public void requestApplicant(String requestCode, Map<String, String> params, boolean isShowLoading) {
        if (isShowLoading){
            mMvpView.showProgressDialog("请稍后...");
        }
        Observable observable = ScheduleMethods.getInstance().applicantRequest(requestCode,params);
        toSubscribe(observable,  new Subscriber<String>() {
            @Override
            public void onCompleted() {
    ...
    @Override
    public void requestManage(String requestCode, Map<String, String> params, boolean isShowLoading) {
        if (isShowLoading){
            mMvpView.showProgressDialog("请稍后...");
        }
        Observable observable = ScheduleMethods.getInstance().manageRequest(requestCode,params);
        toSubscribe(observable,  new Subscriber<String>() {
            @Override
            public void onCompleted() {
