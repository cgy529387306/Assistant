 ...
 */
public class CompetitiveWorkFragment extends BaseMvpFragment<CommonPresenter,ICommonView> implements ICommonView,BaseQuickAdapter.OnItemClickListener,OnRefreshListener, OnLoadMoreListener {
    ...
    public static Fragment getInstance() {
        return new CompetitiveWorkFragment();
    }
    ...
    private void getListFormServer(){
        ...
        mPresenter.requestWork(CodeConstants.KEY_WORK_LIST,requestParams,false);
    }
