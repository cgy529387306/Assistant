 ...
 * 电子申退单详情
 */
public class CertificateDetailsActivity extends BaseMvpActivity<CommonPresenter, ICommonView> implements ICommonView, View.OnClickListener{
        ...
        if (CodeConstants.KEY_CART_ADD.equals(requestCode)){
            ...
            if (resp!=null){
                if (resp.isSuccess()){
                    ...
                    NavigationHelper.startActivity(CertificateDetailsActivity.this, GoodsShoppingCartActivity.class,null,false);
                }else{
    ...
    public class GlideImageLoader extends ImageLoader {
        ...
        public void displayImage(Context context, Object path, ImageView imageView) {
            ImageUtils.displayImage(CertificateDetailsActivity.this,(String)path,imageView);
        }
    }
        ...
        mBanner.setOnBannerListener(new OnBannerListener() {
            ...
            public void OnBannerClick(int position) {
                if (mImageList.size() > 0 && mImageList.size()>position) {
                    ...
                    PictureSelector.create(CertificateDetailsActivity.this).externalPicturePreview(position, dataList);
                }
            }
        });
    }
